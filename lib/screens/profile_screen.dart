...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: drawer != null ? customRed : Colors.white,
        foregroundColor: drawer != null ? Colors.white : Colors.black87,
        elevation: 0,
        centerTitle: true,
        title: drawer != null ? const Text("Profile") : null,
      ),
      drawer: drawer,
                      ...
                      _buildInfoGroup(
                        ...
                        items: [
                          ...
                          if (role == 'student') ...[
                            ...
                            _profileTile(Icons.directions_walk_rounded, "Enrollment Type", _formatStudentType(data['studentType'])),
                            if (data['studentType'] == 'bus_user') 
                              _profileTile(Icons.bus_alert_rounded, "Bus Route", data['busPlace'] ?? 'N/A'),
                          ] else ...[
