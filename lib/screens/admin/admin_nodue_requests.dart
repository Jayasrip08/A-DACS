...
class AdminNoDueRequestsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final primaryRed = const Color(0xFFD32F2F); // A-DACS Corporate Red

    return Scaffold(
      backgroundColor: Colors.grey[50],
      appBar: AppBar(
        title: Text("No-Due Reissue Requests", style: GoogleFonts.outfit(fontWeight: FontWeight.bold)),
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(primaryRed)));
                }
                              ...
                              child: Row(
                                children: [
                                  CircleAvatar(
                                    ...
                                    child: Icon(Icons.person_search_outlined, color: primaryRed, size: 28),
                                  ),
