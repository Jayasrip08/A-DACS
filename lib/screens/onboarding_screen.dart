      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color.fromARGB(255, 198, 55, 45).withOpacity(0.1), // SET: Icon circle background to light red
              shape: BoxShape.circle,
            ),
            child: Icon(
              icon,
              size: 100,
              color: const Color.fromARGB(255, 198, 55, 45), // SET: Icon color to red
            ),
          ...
          ).animate().fadeIn(delay: 400.ms).slideY(begin: 0.2, end: 0, curve: Curves.easeOut),
        ],
      ),
    );
  }
